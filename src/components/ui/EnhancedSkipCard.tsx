...
interface EnhancedSkipCardProps {
  skip: Skip
  isSelected: boolean
...
export function EnhancedSkipCard({ skip, isSelected, onSelect, className = "" }: EnhancedSkipCardProps) {
      ...
      >
        <CardContent className="p-0">
          ...
          <div className="relative overflow-hidden">
            ...
            {/* Deselect Button - Only show when selected and hovered */}
            <AnimatePresence>
              {isSelected && isHovered && (
                <motion.button
                  ...
                  onClick={(e) => {
                    e.stopPropagation()
                    onSelect(skip.id) // This will deselect since it's already selected
                  }}
